...
\toprule
\textbf{Limitación} & \textbf{Descripción} & \textbf{Impacto potencial} \\
\midrule
Diseño retrospectivo & \placeholder{Los datos fueron recolectados retrospectivamente de registros clínicos} & \placeholder{Posible sesgo de selección e información incompleta} \\
Centro único & \placeholder{Datos de una sola institución/región} & \placeholder{Limitación en generalización externa} \\
Periodo temporal & \placeholder{Datos de [periodo], prácticas clínicas pueden haber evolucionado} & \placeholder{Posible drift temporal} \\
Validación interna & \placeholder{Solo validación por división de datos} & \placeholder{Optimismo en estimaciones de rendimiento} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
Sesgo de selección & \placeholder{Medio/Alto/Bajo} & \placeholder{Descripción de criterios de inclusión claros} \\
Sesgo de información & \placeholder{Medio/Alto/Bajo} & \placeholder{Uso de variables objetivas (laboratorio)} \\
Sesgo de confusión & \placeholder{Medio/Alto/Bajo} & \placeholder{Ajuste multivariable, ML captura interacciones} \\
Sesgo de publicación & N/A & Reporte de todos los modelos evaluados \\
Overfitting & \placeholder{Medio/Bajo} & \placeholder{CV, regularización, early stopping} \\
Data leakage & \placeholder{Bajo} & \placeholder{Separación temporal train/test, exclusión de vars post-outcome} \\
\bottomrule
\end{tabular}
\end{table}
