...
\midrule
Repositorio GitHub & \url{https://github.com/Pol4720/mortality-ami-predictor} \\
Documentación & \url{https://pol4720.github.io/mortality-ami-predictor} \\
Dashboard (demo) & Local (Streamlit) \\
MLflow experiments & Local \\
\bottomrule
\end{tabular}
\end{table}
...
Este proyecto esta licenciado bajo \placeholder{MIT / Apache 2.0 / CC}.

Ver archivo LICENSE en el repositorio para detalles.
...
@software{mortalityami2025,
  author = {[AUTORES]},
  title  = {Mortality AMI Predictor: ML para
