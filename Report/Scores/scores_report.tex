...
\begin{itemize}
    ...
    \item \textbf{Tasa de mortalidad observada:} \ph{XX.XX}\%
\end{itemize}
...
Tasa de mortalidad hospitalaria & \ph{XX.XX}\% \\
Edad media (años) & \ph{XX.X $\pm$ XX.X} \\
Sexo masculino (\%) & \ph{XX.X}\% \\
IAMCEST (\%) & \ph{XX.X}\% \\
IAMSEST (\%) & \ph{XX.X}\% \\
Trombolisis realizada (\%) & \ph{XX.X}\% \\
\bottomrule
\end{tabular}
...
\begin{tabular}{lccc}
\toprule
\textbf{Escala} & \textbf{AUROC} & \textbf{IC 95\%} & \textbf{Error Estándar} \\
\midrule
GRACE Score & \ph{0.XXX} & [\ph{0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
TIMI-STEMI & \ph{0.XXX} & [\ph{0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
TIMI-NSTEMI & \ph{0.XXX} & [\ph{0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
RECUIMA Score & \ph{0.XXX} & [\ph{0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
\bottomrule
\end{tabular}
...
\midrule
GRACE Score & \ph{XX.XX} & \ph{X} & \ph{0.XXX} \\
TIMI-STEMI & \ph{XX.XX} & \ph{X} & \ph{0.XXX} \\
TIMI-NSTEMI & \ph{XX.XX} & \ph{X} & \ph{0.XXX} \\
RECUIMA Score & \ph{XX.XX} & \ph{X} & \ph{0.XXX} \\
\bottomrule
\end{tabular}
...
\midrule
Sensibilidad (\%) & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} \\
Especificidad (\%) & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} \\
Precisión (\%) & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} \\
Recall (\%) & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} \\
F1-Score & \ph{0.XXX} & \ph{0.XXX} & \ph{0.XXX} & \ph{0.XXX} \\
VPP (\%) & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} \\
VPN (\%) & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} \\
RV+ & \ph{X.XX} & \ph{X.XX} & \ph{X.XX} & \ph{X.XX} \\
RV- & \ph{0.XX} & \ph{0.XX} & \ph{0.XX} & \ph{0.XX} \\
Exactitud (\%) & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} & \ph{XX.XX} \\
\bottomrule
\end{tabular}
...
\midrule
RECUIMA vs GRACE & \ph{0.XXX} & [\ph{-0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
RECUIMA vs TIMI-STEMI & \ph{0.XXX} & [\ph{-0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
RECUIMA vs TIMI-NSTEMI & \ph{0.XXX} & [\ph{-0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
GRACE vs TIMI-STEMI & \ph{0.XXX} & [\ph{-0.XXX} - \ph{0.XXX}] & \ph{0.XXX} \\
\bottomrule
\end{tabular}
...
\begin{tabular}{lcccc}
\toprule
\textbf{Escala} & \multicolumn{2}{c}{\textbf{IAMCEST}} & \multicolumn{2}{c}{\textbf{IAMSEST}} \\
\cmidrule(lr){2-3} \cmidrule(lr){4-5}
 & AUROC & IC 95\% & AUROC & IC 95\% \\
\midrule
GRACE & \ph{0.XXX} & [\ph{0.XXX}-\ph{0.XXX}] & \ph{0.XXX} & [\ph{0.XXX}-\ph{0.XXX}] \\
TIMI & \ph{0.XXX} & [\ph{0.XXX}-\ph{0.XXX}] & \ph{0.XXX} & [\ph{0.XXX}-\ph{0.XXX}] \\
RECUIMA & \ph{0.XXX} & [\ph{0.XXX}-\ph{0.XXX}] & \ph{0.XXX} & [\ph{0.XXX}-\ph{0.XXX}] \\
\bottomrule
\end{tabular}
...
\begin{tabular}{lcccc}
\toprule
\textbf{Escala} & \textbf{$<$65 años} & \textbf{65-75 años} & \textbf{$>$75 años} \\
\midrule
GRACE & \ph{0.XXX} & \ph{0.XXX} & \ph{0.XXX} \\
TIMI-STEMI & \ph{0.XXX} & \ph{0.XXX} & \ph{0.XXX} \\
RECUIMA & \ph{0.XXX} & \ph{0.XXX} & \ph{0.XXX} \\
\bottomrule
\end{tabular}
...
\textbf{Escala GRACE:}
\begin{itemize}
    \item AUROC observada: \ph{0.XXX}
    \item Comparación con literatura: La capacidad discriminatoria observada es \ph{inferior/similar/superior} a la reportada en las validaciones originales (ABC 0.83-0.85).
    \item La menor disponibilidad de troponinas en Cuba puede afectar el cálculo preciso del score GRACE.
\end{itemize}

\textbf{Escala TIMI:}
\begin{itemize}
    \item AUROC observada (STEMI): \ph{0.XXX}
    \item AUROC observada (NSTEMI): \ph{0.XXX}
    \item El TIMI fue diseñado en poblaciones de ensayos clínicos con fibrinolíticos específicos de fibrina, lo que puede limitar su aplicabilidad en el contexto cubano.
\end{itemize}
...
\begin{itemize}
    ...
    \item Los resultados son \ph{consistentes/variables} con las validaciones previas (ABC 0.89-0.90).
\end{itemize}
...
\begin{itemize}
    \item \textbf{Objetivo mínimo de mejora:} Un modelo de ML debería superar el AUROC de la mejor escala clínica (\ph{RECUIMA/GRACE}: \ph{0.XXX}).
...
\begin{enumerate}
    \item La escala \ph{RECUIMA/GRACE} mostró el mejor rendimiento discriminativo sobre el dataset RECUIMA con un AUROC de \ph{0.XXX} (IC 95\%: \ph{0.XXX-0.XXX}).
    
    \item La escala RECUIMA, diseñada específicamente para el contexto cubano, demostró rendimiento \ph{superior/comparable/inferior} a GRACE, lo cual es \ph{consistente/inconsistente} con los hallazgos de la tesis doctoral de Santos Medina (2022).
    
    \item Las escalas TIMI mostraron capacidad discriminatoria \ph{buena/regular/limitada}, con AUROC de \ph{0.XXX} para STEMI y \ph{0.XXX} para NSTEMI.
    
    \item La calibración de las escalas fue \ph{adecuada/inadecuada} según la prueba de Hosmer-Lemeshow.
\end{enumerate}
...
\midrule
AUROC máxima (mejor escala clínica) & \ph{0.XXX} \\
Sensibilidad de referencia & \ph{XX.XX}\% \\
Especificidad de referencia & \ph{XX.XX}\% \\
F1-Score de referencia & \ph{0.XXX} \\
VPN de referencia & \ph{XX.XX}\% \\
\bottomrule
\end{tabular}
